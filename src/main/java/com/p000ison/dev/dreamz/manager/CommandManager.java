...
import com.p000ison.dev.dreamz.manager.commands.Command;
...
public class CommandManager {
    ...
    public boolean dispatch(final CommandSender sender, org.bukkit.command.Command command, String label, String[] args) {
    ...
    public static boolean hasPermission(CommandSender sender, String permission) {
        ...
        return DreamZ.hasPermission((Player) sender, permission);
    }
}